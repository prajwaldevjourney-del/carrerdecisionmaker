    ...
    <div className="app-bg text-[var(--text)] min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          <h1 className="text-xl font-semibold text-[var(--text)] mb-1">Create an account</h1>
          <p className="text-sm text-[var(--text-muted)] mb-8">
            Already have an account?{" "}
            <Link href="/login" className="text-[var(--text)] underline underline-offset-2">Log in</Link>
          </p>
